...
Page({
  data: {
    ...
    goods: {
      ...
      gallery:[
        '/images/tmp/lianhua.png',
        '/images/tmp/kuaike.png',
        '/images/tmp/banlangen.png',
      ],
    ...
    tmpSpecText: '请选择规格数量',
    checkedSpecPrice: 9.99,
    openAttr: false,
    openShare: false,
    noCollectImage: '/images/assets/icon_collect.png',
    hasCollectImage: '/images/assets/icon_collect_checked.png',
    collectImage: '/images/assets/icon_collect.png',
    shareImage: '',
